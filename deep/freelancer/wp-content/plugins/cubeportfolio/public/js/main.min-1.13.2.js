...
(function($, window, document, undefined) {
    ...
    function CubePortfolio(obj, options, callback) {
		...
		// BOLDWAY 2020 endof fix protocols
...
(function($, window, document, undefined) {
    ...
    jQuery.extend(CubePortfolio.prototype, {
        ...
        mosaicLayout: function() {
            ...
            //BOLDWAY [ hack para saltar as contas nos helpers que sao usados para fazer os scrolling folios. ]
        ...
        t.parent.$obj.on('initComplete.cbp', function() {
            t.loadMoreObj = Object.create({
                ...
                getNewItems: function() {
                    ...
                    topLoadMore = (t.loadMore.length) ? t.loadMore.offset().top : 0; /* BOLDWAYadicionou se verificacao da existencia do loadmore pq estava a spamar erros no single proj */
                    topWindow = self.window.scrollTop() + self.window.height();
